...
<body class="home page-id-2 page-template-default js-images-loading">
<?php
session_start();
session_unset();
session_destroy();
...
<div id="my_popup" style="display:none;">
   ...
   <div style="width:566px;border:1px solid #90958f;background:#FFF; float: right; padding:30px; height:330px; border-radius: 5px;">
	<div>
       <p style="font-size:14px;color:#f00;" id="notification"></p>
<form id="form_id" method="post" name="myform" action="sso/ssoTest.php" style="margin-top:20px;">
<!--label style="color:#FFF;font-size:25px;margin-bottom:20px; width:inherit;padding-bottom:20px;">Single Sign On</label-->
	...
	<div class="head" data-height="100">
			<div class="newWish">
